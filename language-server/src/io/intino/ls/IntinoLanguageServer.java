...
//		capabilities.setHoverProvider(true);
		...
		helpOptions.setWorkDoneProgress(true);
...
//		capabilities.setDocumentSymbolProvider(true);
		...
		fileCaps.setDidCreate(new FileOperationOptions(List.of(new FileOperationFilter(new FileOperationPattern("*.tara")))));
		fileCaps.setDidRename(new FileOperationOptions(List.of(new FileOperationFilter(new FileOperationPattern("*.tara")))));
		fileCaps.setDidDelete(new FileOperationOptions(List.of(new FileOperationFilter(new FileOperationPattern("*.tara")))));
