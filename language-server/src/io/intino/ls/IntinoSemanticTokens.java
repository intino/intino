...
import static io.intino.tara.language.grammar.HighlightTaraLexer.*;
...
public class IntinoSemanticTokens {
	...
	private static final List<String> functions = FunctionCallExpression.registeredFunctions();
	...
	static {
		...
		ANTLR_TOKEN_TYPES.put(IN, tokenTypes.indexOf(Keyword));
		ANTLR_TOKEN_TYPES.put(AND, tokenTypes.indexOf(Keyword));
		ANTLR_TOKEN_TYPES.put(OR, tokenTypes.indexOf(Keyword));
		ANTLR_TOKEN_TYPES.put(NOT, tokenTypes.indexOf(Keyword));
		ANTLR_TOKEN_TYPES.put(C_IS, tokenTypes.indexOf(Keyword));
		ANTLR_TOKEN_TYPES.put(LIKE, tokenTypes.indexOf(Keyword));
		ANTLR_TOKEN_TYPES.put(MATCHES, tokenTypes.indexOf(Keyword));
		ANTLR_TOKEN_TYPES.put(STARTS_WITH, tokenTypes.indexOf(Keyword));
		ANTLR_TOKEN_TYPES.put(C_EMPTY, tokenTypes.indexOf(Keyword));
		ANTLR_TOKEN_TYPES.put(C_NATURAL_VALUE, tokenTypes.indexOf(Number));
		ANTLR_TOKEN_TYPES.put(C_NEGATIVE_VALUE, tokenTypes.indexOf(Number));
		ANTLR_TOKEN_TYPES.put(C_DOUBLE_VALUE, tokenTypes.indexOf(Number));

		ANTLR_TOKEN_TYPES.put(ON, tokenTypes.indexOf(Keyword));
		ANTLR_TOKEN_TYPES.put(WITH, tokenTypes.indexOf(Keyword));
		ANTLR_TOKEN_TYPES.put(CONSTRAINT, tokenTypes.indexOf(Keyword));
		ANTLR_TOKEN_TYPES.put(TRUE_BOOLEAN_VALUE, tokenTypes.indexOf(Keyword));
		ANTLR_TOKEN_TYPES.put(FALSE_BOOLEAN_VALUE, tokenTypes.indexOf(Keyword));
		...
		ANTLR_TOKEN_TYPES.put(NOT_EQUALS, tokenTypes.indexOf(Operator));
		ANTLR_TOKEN_TYPES.put(GREATER, tokenTypes.indexOf(Operator));
		ANTLR_TOKEN_TYPES.put(GREATER_EQUALS, tokenTypes.indexOf(Operator));
		ANTLR_TOKEN_TYPES.put(COMPARER_EQUALS, tokenTypes.indexOf(Operator));
		ANTLR_TOKEN_TYPES.put(LESS, tokenTypes.indexOf(Operator));
		ANTLR_TOKEN_TYPES.put(LESS_EQUALS, tokenTypes.indexOf(Operator));
		ANTLR_TOKEN_TYPES.put(LAMBDA, tokenTypes.indexOf(Operator));
	...
	public List<SemanticToken> semanticTokens(CommonTokenStream tokens) {
		...
		for (int i = 0; i < tokens.size(); i++) {
			...
			if (type != null && (token.getType() == ID || functions.contains(token.getText())))
				type = IntinoSemanticTokens.tokenTypes.indexOf(Function);
