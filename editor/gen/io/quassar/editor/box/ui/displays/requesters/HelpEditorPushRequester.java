...
public class HelpEditorPushRequester extends io.intino.alexandria.ui.displays.requesters.DisplayPushRequester {

	public void execute(UIClient client, UIMessage message) {
		HelpEditor display = display(client, message);
