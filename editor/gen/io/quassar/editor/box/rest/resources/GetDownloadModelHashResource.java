...
public class GetDownloadModelHashResource implements Resource {

	private EditorBox box;
	private AlexandriaHttpManager<PushService<?,?>> manager;

	public GetDownloadModelHashResource(EditorBox box, AlexandriaHttpManager manager) {
		this.box = box;
		this.manager = manager;
	}

	public void execute() throws AlexandriaException {
		write(fill(new io.quassar.editor.box.actions.GetDownloadModelHashAction()).execute());
	}

	private io.quassar.editor.box.actions.GetDownloadModelHashAction fill(io.quassar.editor.box.actions.GetDownloadModelHashAction action) throws AlexandriaException {
		action.box = this.box;
