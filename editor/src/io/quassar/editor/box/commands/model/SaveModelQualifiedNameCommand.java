...
public class SaveModelQualifiedNameCommand extends Command<Boolean> {
	public Model model;
	public String project;
	public String module;

	public SaveModelQualifiedNameCommand(EditorBox box) {
		super(box);
	}

	@Override
	public Boolean execute() {
		model.name(project.toUpperCase(), module.toUpperCase());
		notifyTitleChange();
		return true;
	}
