...
public class PathHelper {
	...
	public static String commitUrl(UISession session) {
		return session.browser().baseUrl() + "/commits";
	}
	...
	public static String modelViewPath(Model model, String release, LanguageTab tab, ModelView view) {
		String result = ModelPath.replace(":language", model.language().languageId()).replace(":model", model.id()).replace(":release", release);
		result += tab != null ? "?tab=" + tab.name() : "";
	...
	public static String forgePath(String address, String model, String release) {
		return address.replace(":model", model).replace(":release", release);
	}

	public static String forgePathPattern(String address, String model, String release) {
