...
public class DisplayHelper {
	...
	public static double DefaultLeftPanelSize = 20;
	public static double DefaultRightPanelSize = 30;
	...
	public static CheckResult checkLanguageName(String name, Function<String, String> translator) {
		...
		if (!NameHelper.validLanguageName(name)) return new CheckResult(false, translator.apply("Name contains non alphanumeric characters"));
