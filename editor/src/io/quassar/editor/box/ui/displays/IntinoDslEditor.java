...
public class IntinoDslEditor extends AbstractIntinoDslEditor<EditorBox> {
	...
	public void file(File file, FilePosition position) {
		this.reloadRequired = this.selectedFile == null || file == null || !this.selectedFile.uri().equals(file.uri());
	...
	public void executeCommand(String name) {
		if (name.equalsIgnoreCase("check")) checkListener.accept(true);
		if (name.equalsIgnoreCase("commit")) commitListener.accept(true);
	}
