...
public class ModelHeaderTemplate extends AbstractModelHeaderTemplate<EditorBox> {
	...
	private Consumer<String> openReleaseListener;
	...
	public void onOpenRelease(Consumer<String> listener) {
		this.openReleaseListener = listener;
	}
	...
	private void openRelease(String release) {
		...
		openReleaseListener.accept(releaseName);
